        ...
        <div className="bg-[#FFFDFD] border border-black rounded-xl p-4 mb-6 shadow-sm w-full max-w-5xl">
            <div className="grid grid-cols-[120px_1fr] gap-4">
                <div className="flex flex-col items-start">
                    ...
                    <div className="text-sm font-medium h-full flex items-center">
                        {location}
                    </div>
                </div>
                <div className="w-full">
                    <div className="grid grid-cols-6 text-sm font-semibold border-b border-black pb-2">
                    ...
                    {rows.map((item, index) => (
                        <div
                            key={index}
                            className="grid grid-cols-6 py-4 border-b border-black text-sm items-center"
                        >
                            <div>{item.lot}</div>
